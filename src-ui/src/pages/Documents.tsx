...
function buildTaxInvoiceHtml(
  ...
  *{box-sizing:border-box}body{margin:0;background:#fff;color:#111;font-family:Tahoma,"Sarabun",sans-serif;font-size:10.8px;line-height:1.25}
  ...
  .payment{text-align:left;font-size:11px;line-height:1.15}.payment-title{font-size:11.5px;font-weight:700;color:#315f5f;margin-bottom:1.2mm}.payment-methods{display:flex;align-items:center;justify-content:space-between;gap:1mm;white-space:nowrap;font-size:10.5px;margin-bottom:2.2mm}.check{font-size:14px;font-weight:700;vertical-align:-1px}.payment-grid{display:grid;grid-template-columns:1fr 1fr;column-gap:3mm;row-gap:1.3mm}.payment-field{min-width:0}.payment-field.full{grid-column:1/-1}.payment-label{font-size:10.5px;line-height:1.05;color:#315f5f}.fill-line{height:3.2mm;border-bottom:1px solid #4f8f8f}.line{border-top:1px solid #4f8f8f;padding-top:1mm}
  @media print{.page{padding:0}}
    ...
    <div class="signatures">
      <div class="sign"><div class="payment"><div class="payment-title">ชำระโดย / PAY BY</div><div class="payment-methods"><span><b class="check">□</b> เงินสด CASH</span><span><b class="check">□</b> เช็ค CHEQUE</span><span><b class="check">□</b> เงินโอน TRANSFER</span></div><div class="payment-grid"><div class="payment-field"><div class="payment-label">ธนาคาร<br>BANK</div><div class="fill-line"></div></div><div class="payment-field"><div class="payment-label">สาขา<br>BRANCH</div><div class="fill-line"></div></div><div class="payment-field"><div class="payment-label">เลขที่<br>NO.</div><div class="fill-line"></div></div><div class="payment-field"><div class="payment-label">วันที่<br>DATE</div><div class="fill-line"></div></div><div class="payment-field full"><div class="payment-label">จำนวนเงิน<br>AMOUNT</div><div class="fill-line"></div></div></div></div><div class="line">ผู้รับเงิน / COLLECTOR<br>วันที่ DATE ____/____/____</div></div>
