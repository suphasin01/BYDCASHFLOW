...
function buildTaxInvoiceHtml(
  ...
  *{box-sizing:border-box}body{margin:0;background:#fff;color:#111;font-family:Tahoma,"Sarabun",sans-serif;font-size:10.8px;line-height:1.25}
  ...
  .company{display:flex;max-width:126mm;font-size:12px;line-height:1.35}.company-name{font-size:19px;font-weight:700;margin-bottom:.6mm}
  ...
  .totals{table-layout:fixed}.totals td{font-size:11px;line-height:1.15;vertical-align:middle}.totals td:first-child{width:62%;font-weight:700;color:#315f5f;background:#edf7f5}.totals td:last-child{width:38%;text-align:right;font-weight:700;white-space:nowrap;font-variant-numeric:tabular-nums}.grand td{font-size:12px;font-weight:700;color:#315f5f;background:#edf7f5}
  .signatures{display:grid;grid-template-columns:1.45fr repeat(3,1fr);border-left:1px solid #4f8f8f}.sign{height:44mm;border-right:1px solid #4f8f8f;border-bottom:1px solid #4f8f8f;padding:1.8mm;text-align:center;font-size:10px;display:flex;flex-direction:column;justify-content:space-between}
  .payment{text-align:left;font-size:10.5px;line-height:1.45}.payment-title{font-weight:700;color:#315f5f;margin-bottom:1.5mm}.payment-methods{display:flex;align-items:center;justify-content:space-between;gap:1mm;white-space:nowrap;font-size:9.5px;margin-bottom:3mm}.payment-field{display:grid;grid-template-columns:auto 1fr;gap:1.5mm;align-items:end;margin-top:1.8mm}.payment-field.split{grid-template-columns:auto 1fr auto 23mm}.fill-line{height:4mm;border-bottom:1px solid #4f8f8f}.line{border-top:1px solid #4f8f8f;padding-top:1mm}
  @media print{.page{padding:0}}
    ...
    <div class="signatures">
      <div class="sign"><div class="payment"><div class="payment-title">ชำระโดย / PAY BY</div><div class="payment-methods"><span>□ เงินสด CASH</span><span>□ เช็ค CHEQUE</span><span>□ เงินโอน TRANSFER</span></div><div class="payment-field split"><span>เลขที่</span><span class="fill-line"></span><span>วันที่</span><span class="fill-line"></span></div><div class="payment-field"><span>จำนวนเงิน</span><span class="fill-line"></span></div></div><div class="line">ผู้รับเงิน / COLLECTOR<br>วันที่ DATE ____/____/____</div></div>
