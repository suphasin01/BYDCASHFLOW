            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="border border-content3 rounded-lg p-4">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                  ...
                  <TextField type="number" min={0} label="จำนวนเงินรวมทั้งสิ้น / AMOUNT" value={String(total)} readOnly
                    className="font-semibold text-right cursor-not-allowed" />
                </div>
              </div>
...
function buildTaxInvoiceHtml(
  ...
  *{box-sizing:border-box}body{margin:0;background:#fff;color:#111;font-family:Tahoma,"Sarabun",sans-serif;font-size:10.8px;line-height:1.25}
  ...
  .payment{text-align:left;font-size:11px;line-height:1.15}.payment-methods{display:grid;grid-template-columns:1.15fr 1fr 1fr 1.25fr;align-items:center;column-gap:1mm;white-space:nowrap;font-size:10.5px;margin-bottom:2.4mm}.payment-methods .thai{font-size:11.5px;font-weight:700;color:#315f5f}.payment-methods .en{font-size:10px;font-weight:700;color:#315f5f}.payment-grid{display:grid;grid-template-columns:1fr 1fr;column-gap:3mm;row-gap:1.3mm}.payment-field{min-width:0}.payment-field.full{grid-column:1/-1}.payment-field.full .fill-line{text-align:center}.payment-label{font-size:10.5px;line-height:1.05;color:#315f5f}.fill-line{min-height:5mm;border-bottom:1px solid #4f8f8f;padding-top:1mm;font-size:11px;color:#111}.line{width:88%;margin-left:auto;margin-right:auto;border-top:1px solid #4f8f8f;padding-top:1mm}.payment-sign .line{transform:translateY(1.5mm)}
